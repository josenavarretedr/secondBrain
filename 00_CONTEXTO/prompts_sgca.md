...
6. **Limpieza de Inbox:** Si la ingesta partió de un archivo .md ubicado dentro de `02_RECURSOS/Inbox/`, mueve dicho archivo automáticamente a `02_RECURSOS/Inbox/Procesados/` para limpiar la bandeja de entrada.
